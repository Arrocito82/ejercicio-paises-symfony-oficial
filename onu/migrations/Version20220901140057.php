 ...
 */
final class Version20220901140057 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pais (id INT NOT NULL, codigo INT NOT NULL, nombre VARCHAR(25) NOT NULL, PRIMARY KEY(id))');
